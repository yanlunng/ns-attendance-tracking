(function () {
  var searchInput = document.getElementById('kah-search-input');
  if (!searchInput) return;

  var roster = window.FULL_ROSTER || [];
  var resultsBox = document.getElementById('kah-search-results');
  var hiddenId = document.getElementById('kah-selected-roster-id');
  var form = document.getElementById('kah-add-form');
